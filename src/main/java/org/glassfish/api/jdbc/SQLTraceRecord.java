...
/**
 * Information related to SQL operations executed by the applications are stored
 * in this object.
 * 
...
public class SQLTraceRecord implements Serializable {
	...
	/**
	 * Type of SQL query. Could be PreparedStatement, CallableStatement or other
	 * object types.
	 */
	...
	/**
	 * Gets the parameters of the method that executed the SQL query. Includes
	 * information like SQL query, arguments and so on.
	 * 
	...
	/**
	 * Sets the parameters of the method that executed the SQL query. Includes
	 * information like SQL query, arguments and so on.
	 * 
	...
	public String toString() {
		...
		if (params != null && params.length > 0) {
			...
			for (Object param : params) {
				sb.append("arg[" + index++ + "]=" + ((param == null) ? "" : param.toString()) + " | ");
			}
		}
		return sb.toString();
	}
